...
1. Тег внутри тега для стилей в `base.html` - так не работает)))
2. Отображение меню. Проблема в передачи данных в контекст
...
```
Это единственный и лучший способ это сделать.